...
<body background="">
	...
	<div class="container-sm">
        ...
        <div class="row">
            <form action="showroom.php" method="GET" class="pt-3">
                <div class="row gx-3">
                    <div class="col-sm-2">
                        <input type="text" value="" class="form-control bg bg-light pb-2  " name="id_room" placeholder="กรอกรหัสกลุ่ม" />
                    </div>
                    <div class="col">
        ...
        <?php
        if (isset($_GET['find']) &&  $_GET['id_room'] != '') {
            $id_room = $_GET['id_room'];
            $sql = "SELECT  r.id_room, r.name_room
            FROM     room r
            WHERE   r.id_room = r.id_room
